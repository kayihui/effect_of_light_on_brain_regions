---
title: "SCN all comparsion TopGO(molecular functions, KS elim test) heatmaps"
...
elimKS.result <- read.csv("MF/SCN_all_comparsion_MF_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
