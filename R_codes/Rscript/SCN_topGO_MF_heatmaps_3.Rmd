---
title: "SCN all comparsion TopGO(molecular functions, KS test) heatmaps"
...
KS.result <- read.csv("MF/SCN_all_comparsion_MF_KS.csv", header = TRUE, stringsAsFactors = FALSE)
```
