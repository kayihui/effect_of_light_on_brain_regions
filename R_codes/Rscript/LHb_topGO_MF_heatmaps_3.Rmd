---
title: "LHb all comparsion TopGO(molecular functions, KS test) heatmaps"
...
KS.result <- read.csv("MF/LHb_all_comparsion_MF_KS.csv", header = TRUE, stringsAsFactors = FALSE)
```
