...
saveRDS(GO.data,"BP/NAc_light_topGO_BP.RData")
write.csv(fisher.result, "BP/NAc_light_BP_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "BP/NAc_light_BP_elimfisher.csv", row.names = FALSE)
