...
dds <- readRDS("VTA/VTA_DESeq2DataSet.RData")
...
setwd("~/Desktop/brainRNASeq/R_analysis/R_output/DESeq2Objects")
saveRDS(wt.light.treatment, "VTA/VTA_WT_lightvsControl.RData")
saveRDS(Per1.light.treatment, "VTA/VTA_Per1_lightvsControl.RData")
saveRDS(WTvsPer1.control, "VTA/VTA_WTvsPer1_control.RData")
saveRDS(WTvsPer1.light.treatment, "VTA/VTA_WTvsPer1_light.RData")
saveRDS(different.in.light.response, "VTA/VTA_effectAcrossGenotype.RData")
