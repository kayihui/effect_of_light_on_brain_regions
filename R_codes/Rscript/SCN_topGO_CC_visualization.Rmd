---
title: "SCN all comparsion TopGO(cellular component) analysis"
...
saveRDS(GO.data,"CC/SCN_all_comparsion_topGO_CC.RData")
write.csv(fisher.result, "CC/SCN_all_comparsion_CC_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "CC/SCN_all_comparsionl_CC_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "CC/SCN_all_comparsion_CC_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "CC/SCN_all_comparsion_CC_elimKS.csv", row.names = FALSE)
```
