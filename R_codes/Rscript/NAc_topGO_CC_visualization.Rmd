---
title: "NAc all comparsion TopGO(cellular component) analysis"
...
```{r message=FALSE, warning=FALSE, tidy=TRUE}
GO.data <- new ("topGOdata", ontology ="CC", allGenes = gene.list, 
...
saveRDS(GO.data,"CC/NAc_all_comparsion_topGO_CC.RData")
write.csv(fisher.result, "CC/NAc_all_comparsion_CC_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "CC/NAc_all_comparsionl_CC_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "CC/NAc_all_comparsion_CC_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "CC/NAc_all_comparsion_CC_elimKS.csv", row.names = FALSE)
```
