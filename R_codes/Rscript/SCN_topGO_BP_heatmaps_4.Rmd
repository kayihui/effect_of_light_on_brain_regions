---
title: "SCN all comparsion TopGO(Biological process, KS elim test) heatmaps"
...
elimKS.result <- read.csv("BP/SCN_all_comparsion_BP_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
