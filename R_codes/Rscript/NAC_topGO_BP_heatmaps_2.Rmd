---
title: "NAc all comparsion TopGO(Biological process, fisher elim test) heatmaps"
...
BP.GO.data <- readRDS("BP/NAc_all_comparsion_topGO_BP.RData")
elimfisher.result <- read.csv("BP/NAc_all_comparsion_BP_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
