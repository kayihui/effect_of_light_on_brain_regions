...
# annotations and remark. This script is for VTA region
...
result.wt.light.treatment <- readRDS("VTA/VTA_WT_lightvsControl.RData")
result.Per1.light.treatment <- readRDS("VTA/VTA_Per1_lightvsControl.RData")
result.WTvsPer1.control <- readRDS("VTA/VTA_WTvsPer1_control.RData")
result.WTvsPer1.light.treatment <- readRDS("VTA/VTA_WTvsPer1_light.RData")
result.different.in.light.response <- readRDS("VTA/VTA_effectAcrossGenotype.RData")
...
write.csv(wt.light.treatment, "VTA/VTA_WT_lightvsControl.csv", row.names = FALSE)
write.csv(Per1.light.treatment, "VTA/VTA_Per1_lightvsControl.csv", row.names = FALSE)
write.csv(WTvsPer1.control, "VTA/VTA_WTvsPer1_control.csv", row.names = FALSE)
write.csv(WTvsPer1.light.treatment, "VTA/VTA_WTvsPer1_light.csv", row.names = FALSE)
write.csv(different.in.light.response, "VTA/VTA_effectAcrossGenotype.csv", row.names = FALSE)
...
write.csv(Fulltable, "VTA/VTA_all_comparsion.csv", row.names = FALSE)
