...
# annotations and remark. This script is for NAc region
...
result.wt.light.treatment <- readRDS("NAc/NAc_WT_lightvsControl.RData")
result.Per1.light.treatment <- readRDS("NAc/NAc_Per1_lightvsControl.RData")
result.WTvsPer1.control <- readRDS("NAc/NAc_WTvsPer1_control.RData")
result.WTvsPer1.light.treatment <- readRDS("NAc/NAc_WTvsPer1_light.RData")
result.different.in.light.response <- readRDS("NAc/NAc_effectAcrossGenotype.RData")
...
Per1.light.treatment <- addRemark(Per1.light.treatment)
...
write.csv(wt.light.treatment, "NAc/NAc_WT_lightvsControl.csv", row.names = FALSE)
write.csv(Per1.light.treatment, "NAc/NAc_Per1_lightvsControl.csv", row.names = FALSE)
write.csv(WTvsPer1.control, "NAc/NAc_WTvsPer1_control.csv", row.names = FALSE)
write.csv(WTvsPer1.light.treatment, "NAc/NAc_WTvsPer1_light.csv", row.names = FALSE)
write.csv(different.in.light.response, "NAc/NAc_effectAcrossGenotype.csv", row.names = FALSE)
...
write.csv(Fulltable, "NAc/NAc_all_comparsion.csv", row.names = FALSE)
