---
title: "SCN all comparsion TopGO(molecular functions, fisher elim test) heatmaps"
...
MF.GO.data <- readRDS("MF/SCN_all_comparsion_topGO_MF.RData")
elimfisher.result <- read.csv("MF/SCN_all_comparsion_MF_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```

```{r message=FALSE, warning=FALSE, tidy=TRUE}
#read in the rlog transformation table
setwd("~/Desktop/brainRNASeq/R_analysis/R_output/results_tables/")
rlog.transformed.data <- read.csv("SCN/SCN_rlog_transformated_data.csv", header = TRUE, stringsAsFactors = FALSE)
```
