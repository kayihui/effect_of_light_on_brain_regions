---
title: "LHb all comparsion TopGO(Biological process, fisher elim test) heatmaps"
...
elimfisher.result <- read.csv("BP/LHb_all_comparsion_BP_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
