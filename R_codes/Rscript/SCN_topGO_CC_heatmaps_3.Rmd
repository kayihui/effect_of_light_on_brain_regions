---
title: "SCN all comparsion TopGO(cellular component, KS test) heatmaps"
...
KS.result <- read.csv("CC/SCN_all_comparsion_CC_KS.csv", header = TRUE, stringsAsFactors = FALSE)
```
