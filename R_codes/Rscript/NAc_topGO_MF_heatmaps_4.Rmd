---
title: "NAc all comparsion TopGO(molecular functions, KS elim test) heatmaps"
...
elimKS.result <- read.csv("MF/NAc_all_comparsion_MF_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
