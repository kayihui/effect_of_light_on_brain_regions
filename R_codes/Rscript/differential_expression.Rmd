...
---
Please note that this is a generic script, please edit the file names, directory,
labelling of the graphs accordingly.
...
dds.results.table <- read.csv("... .csv", header = TRUE,
...
setwd("~/Desktop/brainRNASeq/R_analysis/R_output/results_tables/")
rlog.transformated <- read.csv("... .csv")
