...
MF.GO.data <- readRDS("MF/VTA_all_comparsion_topGO_MF.RData")
elimfisher.result <- read.csv("MF/VTA_all_comparsion_MF_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
