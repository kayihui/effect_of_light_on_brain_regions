---
title: "Differential gene expression visualization - LHb WTvsPer1_control"
...
dds.results <- readRDS("LHb/LHb_WTvsPer1_control.RData")
```
...
dds.results.table <- read.csv("LHb_WTvsPer1_control.csv", header = TRUE,
