---
title: "Differential gene expression visualization - LHb WT_lightvsControl"
...
dds.results <- readRDS("LHb/LHb_WT_lightvsControl.RData")
```
...
dds.results.table <- read.csv("LHb_WT_lightvsControl.csv", header = TRUE,
