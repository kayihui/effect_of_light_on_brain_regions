---
title: "Differential gene expression visualization - SCN WTvsPer1_light"
...
dds.results <- readRDS("SCN/SCN_WTvsPer1_light.RData")
```
...
dds.results.table <- read.csv("SCN_WTvsPer1_light.csv", header = TRUE,
