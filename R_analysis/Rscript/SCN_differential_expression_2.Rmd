---
title: "Differential gene expression visualization - SCN Per1_lightvsControl"
...
dds.results <- readRDS("SCN/SCN_Per1_lightvsControl.RData")
```
...
dds.results.table <- read.csv("SCN_Per1_lightvsControl.csv", header = TRUE,
