---
title: "SCN all comparsion TopGO(molecular functions) analysis"
...
result <- read.csv("SCN/SCN_all_comparsion.csv", header = TRUE, 
...
```{r message=FALSE, warning=FALSE, tidy=TRUE}
GO.data <- new ("topGOdata", ontology ="MF", allGenes = gene.list, 
...
saveRDS(GO.data,"MF/SCN_all_comparsion_topGO_MF.RData")
write.csv(fisher.result, "MF/SCN_all_comparsion_MF_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "MF/SCN_all_comparsionl_MF_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "MF/SCN_all_comparsion_MF_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "MF/SCN_all_comparsion_MF_elimKS.csv", row.names = FALSE)
```
