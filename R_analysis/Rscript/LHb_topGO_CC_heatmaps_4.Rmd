---
title: "LHb all comparsion TopGO(cellular component, KS elim test) heatmaps"
...
elimKS.result <- read.csv("CC/LHb_all_comparsion_CC_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
