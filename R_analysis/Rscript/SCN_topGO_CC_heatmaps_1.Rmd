---
title: "SCN all comparsion TopGO(cellular component, fisher test) heatmaps"
...
fisher.result <- read.csv("CC/SCN_all_comparsion_CC_fisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
