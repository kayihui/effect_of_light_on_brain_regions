---
title: "Differential gene expression visualization - LHb WTvsPer1_light"
...
dds.results <- readRDS("LHb/LHb_WTvsPer1_light.RData")
```
...
dds.results.table <- read.csv("LHb_WTvsPer1_light.csv", header = TRUE,
