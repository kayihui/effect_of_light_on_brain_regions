---
title: "Differential gene expression visualization - VTA Per1_lightvsControl"
...
dds.results <- readRDS("VTA/VTA_Per1_lightvsControl.RData")
```
...
dds.results.table <- read.csv("VTA_Per1_lightvsControl.csv", header = TRUE,
