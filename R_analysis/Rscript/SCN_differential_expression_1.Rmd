---
title: "Differential gene expression visualization - SCN WT_lightvsControl"
...
dds.results <- readRDS("SCN/SCN_WT_lightvsControl.RData")
```
...
dds.results.table <- read.csv("SCN_WT_lightvsControl.csv", header = TRUE,
