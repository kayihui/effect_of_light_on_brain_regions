---
title: "Differential gene expression visualization - VTA WT_lightvsControl"
...
dds.results <- readRDS("VTA/VTA_WT_lightvsControl.RData")
```
...
dds.results.table <- read.csv("VTA_WT_lightvsControl.csv", header = TRUE,
