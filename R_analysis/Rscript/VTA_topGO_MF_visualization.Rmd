---
title: "VTA all comparsion TopGO(molecular functions) analysis"
...
result <- read.csv("VTA/VTA_all_comparsion.csv", header = TRUE, 
...
saveRDS(GO.data,"MF/VTA_all_comparsion_topGO_MF.RData")
write.csv(fisher.result, "MF/VTA_all_comparsion_MF_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "MF/VTA_all_comparsion_MF_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "MF/VTA_all_comparsion_MF_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "MF/VTA_all_comparsion_MF_elimKS.csv", row.names = FALSE)
```
