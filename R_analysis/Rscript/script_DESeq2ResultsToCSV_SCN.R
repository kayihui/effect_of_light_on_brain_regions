...
# annotations and remark. This script is for SCN region
...
result.wt.light.treatment <- readRDS("SCN/SCN_WT_lightvsControl.RData")
result.Per1.light.treatment <- readRDS("SCN/SCN_Per1_lightvsControl.RData")
result.WTvsPer1.control <- readRDS("SCN/SCN_WTvsPer1_control.RData")
result.WTvsPer1.light.treatment <- readRDS("SCN/SCN_WTvsPer1_light.RData")
result.different.in.light.response <- readRDS("SCN/SCN_effectAcrossGenotype.RData")
...
write.csv(wt.light.treatment, "SCN/SCN_WT_lightvsControl.csv", row.names = FALSE)
write.csv(Per1.light.treatment, "SCN/SCN_Per1_lightvsControl.csv", row.names = FALSE)
write.csv(WTvsPer1.control, "SCN/SCN_WTvsPer1_control.csv", row.names = FALSE)
write.csv(WTvsPer1.light.treatment, "SCN/SCN_WTvsPer1_light.csv", row.names = FALSE)
write.csv(different.in.light.response, "SCN/SCN_effectAcrossGenotype.csv", row.names = FALSE)
...
write.csv(Fulltable, "SCN/SCN_all_comparsion.csv", row.names = FALSE)
