---
title: "Differential gene expression visualization - LHb effect across the genotype"
...
dds.results <- readRDS("LHb/LHb_effectAcrossGenotype.RData")
```
...
dds.results.table <- read.csv("LHb_effectAcrossGenotype.csv", header = TRUE,
