---
title: "NAc all comparsion TopGO(Biological process) analysis"
...
saveRDS(GO.data,"BP/NAc_all_comparsion_topGO_BP.RData")
write.csv(fisher.result, "BP/NAc_all_comparsion_BP_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "BP/NAc_all_comparsion_BP_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "BP/NAc_all_comparsion_BP_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "BP/NAc_all_comparsion_BP_elimKS.csv", row.names = FALSE)
```
