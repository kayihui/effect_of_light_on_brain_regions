---
title: "LHb all comparsion TopGO(molecular functions, fisher elim test) heatmaps"
...
MF.GO.data <- readRDS("MF/LHb_all_comparsion_topGO_MF.RData")
elimfisher.result <- read.csv("MF/LHb_all_comparsion_MF_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
