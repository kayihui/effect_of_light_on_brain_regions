...
# annotations and remark. This script is for LHb region
...
result.wt.light.treatment <- readRDS("LHb/LHb_WT_lightvsControl.RData")
result.Per1.light.treatment <- readRDS("LHb/LHb_Per1_lightvsControl.RData")
result.WTvsPer1.control <- readRDS("LHb/LHb_WTvsPer1_control.RData")
result.WTvsPer1.light.treatment <- readRDS("LHb/LHb_WTvsPer1_light.RData")
result.different.in.light.response <- readRDS("LHb/LHb_effectAcrossGenotype.RData")
...
write.csv(wt.light.treatment, "LHb/LHb_WT_lightvsControl.csv", row.names = FALSE)
write.csv(Per1.light.treatment, "LHb/LHb_Per1_lightvsControl.csv", row.names = FALSE)
write.csv(WTvsPer1.control, "LHb/LHb_WTvsPer1_control.csv", row.names = FALSE)
write.csv(WTvsPer1.light.treatment, "LHb/LHb_WTvsPer1_light.csv", row.names = FALSE)
write.csv(different.in.light.response, "LHb/LHb_effectAcrossGenotype.csv", row.names = FALSE)
...
write.csv(Fulltable, "LHb/LHb_all_comparsion.csv", row.names = FALSE)
