---
title: "Differential gene expression visualization - NAc Per1_lightvsControl"
...
dds.results <- readRDS("NAc/NAc_Per1_lightvsControl.RData")
```
...
dds.results.table <- read.csv("NAc_Per1_lightvsControl.csv", header = TRUE,
...
setwd("~/Desktop/brainRNASeq/R_analysis/R_output/results_tables/NAc")
rlog.transformated <- read.csv("NAc_rlog_transformated_data.csv")
