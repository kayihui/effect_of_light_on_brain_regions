---
title: "NAc all comparsion TopGO(cellular component, KS test) heatmaps"
...
KS.result <- read.csv("CC/NAc_all_comparsion_CC_KS.csv", header = TRUE, stringsAsFactors = FALSE)
```
