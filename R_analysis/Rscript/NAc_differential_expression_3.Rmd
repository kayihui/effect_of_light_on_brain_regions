---
title: "Differential gene expression visualization - NAc WTvsPer1_control"
...
dds.results <- readRDS("NAc/NAc_WTvsPer1_control.RData")
```
...
dds.results.table <- read.csv("NAc_WTvsPer1_control.csv", header = TRUE,
