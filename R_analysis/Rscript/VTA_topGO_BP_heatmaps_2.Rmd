...
BP.GO.data <- readRDS("BP/VTA_all_comparsion_topGO_BP.RData")
elimfisher.result <- read.csv("BP/VTA_all_comparsion_BP_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
