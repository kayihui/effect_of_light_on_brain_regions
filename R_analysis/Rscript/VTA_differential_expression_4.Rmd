---
title: "Differential gene expression visualization - VTA WTvsPer1_light"
...
dds.results <- readRDS("VTA/VTA_WTvsPer1_light.RData")
```
...
dds.results.table <- read.csv("VTA_WTvsPer1_light.csv", header = TRUE,
