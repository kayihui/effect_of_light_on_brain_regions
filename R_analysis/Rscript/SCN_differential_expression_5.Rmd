---
title: "Differential gene expression visualization - SCN effect across the genotype"
...
dds.results <- readRDS("SCN/SCN_effectAcrossGenotype.RData")
```
...
hist(dds.results$pvalue, breaks = 20, col ='grey', 
		 main = "TEffect across genotype", xlab = "pvalue", ylab = "Frequency")
```
