---
title: "Differential gene expression visualization - NAc WTvsPer1_light"
...
dds.results <- readRDS("NAc/NAc_WTvsPer1_light.RData")
```
...
ggplot(dds.results.table, aes(x=log2FoldChange, y= -log10(pvalue))) + 
	                         ...
	                         ggtitle("WT vs Per1 mutant (light) Volcano plot")
```
