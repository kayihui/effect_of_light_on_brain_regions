---
title: "Differential gene expression visualization - NAc effect across the genotype"
...
dds.results <- readRDS("NAc/NAc_effectAcrossGenotype.RData")
```
...
dds.results.table <- read.csv("NAc_effectAcrossGenotype.csv", header = TRUE,
