---
title: "Differential gene expression visualization - VTA WTvsPer1_control"
...
dds.results <- readRDS("VTA/VTA_WTvsPer1_control.RData")
```
...
dds.results.table <- read.csv("VTA_WTvsPer1_control.csv", header = TRUE,
