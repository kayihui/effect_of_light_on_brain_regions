---
title: "SCN all comparsion TopGO(cellular component, fisher elim test) heatmaps"
...
CC.GO.data <- readRDS("CC/SCN_all_comparsion_topGO_CC.RData")
elimfisher.result <- read.csv("CC/SCN_all_comparsion_CC_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
