...
setwd("~/Desktop/brainRNASeq/R_analysis/R_output/DESeq2Objects")
saveRDS(wt.light.treatment, "LHb/LHb_WT_lightvsControl.RData")
saveRDS(Per1.light.treatment, "LHb/LHb_Per1_lightvsControl.RData")
saveRDS(WTvsPer1.control, "LHb/LHb_WTvsPer1_control.RData")
saveRDS(WTvsPer1.light.treatment, "LHb/LHb_WTvsPer1_light.RData")
saveRDS(different.in.light.response, "LHb/LHb_effectAcrossGenotype.RData")
