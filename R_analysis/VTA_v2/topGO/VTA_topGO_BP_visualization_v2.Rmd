...
```{r}
saveRDS(GO.data,"BP/VTA_v2_all_comparsion_topGO_BP.RData")
write.csv(fisher.result, "BP/VTA_v2_all_comparsion_BP_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "BP/VTA_v2_all_comparsion_BP_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "BP/VTA_v2_all_comparsion_BP_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "BP/VTA_v2_all_comparsion_BP_elimKS.csv", row.names = FALSE)
```
