---
title: "VTA all comparsion TopGO(molecular functions, fisher elim test) heatmaps"
...
MF.GO.data <- readRDS("topGO/MF/VTA_v2_all_comparsion_topGO_MF.RData")
elimfisher.result <- read.csv("topGO/MF/VTA_v2_all_comparsion_MF_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)

#read in the rlog transformation table
rlog.transformed.data <- read.csv("VTA_v2_rlog_transformated_data.csv", header = TRUE, stringsAsFactors = FALSE)
```
