---
title: "VTA all comparsion TopGO(Biological process, KS elim test) heatmaps"
...
elimKS.result <- read.csv("topGO/BP/VTA_v2_all_comparsion_BP_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
