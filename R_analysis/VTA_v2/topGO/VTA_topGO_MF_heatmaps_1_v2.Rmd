---
title: "VTA all comparsion TopGO(molecular functions, fisher test) heatmaps"
...
fisher.result <- read.csv("topGO/MF/VTA_v2_all_comparsion_MF_fisher.csv", header = TRUE, stringsAsFactors = FALSE)
