---
title: "VTA all comparsion TopGO(cellular component, fisher test) heatmaps"
...
fisher.result <- read.csv("topGO/CC/VTA_v2_all_comparsion_CC_fisher.csv", header = TRUE, stringsAsFactors = FALSE)
