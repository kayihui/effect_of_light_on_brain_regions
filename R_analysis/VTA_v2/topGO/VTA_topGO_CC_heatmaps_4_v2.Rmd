---
title: "VTA all comparsion TopGO(cellular component, KS elim test) heatmaps"
...
elimKS.result <- read.csv("topGO/CC/VTA_v2_all_comparsion_CC_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
