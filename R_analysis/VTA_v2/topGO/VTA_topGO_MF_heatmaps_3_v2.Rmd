---
title: "VTA all comparsion TopGO(molecular functions, KS test) heatmaps"
...
KS.result <- read.csv("topGO/MF/VTA_v2_all_comparsion_MF_KS.csv", header = TRUE, stringsAsFactors = FALSE)
