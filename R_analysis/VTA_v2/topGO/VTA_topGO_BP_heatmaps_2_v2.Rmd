---
title: "VTA all comparsion TopGO(Biological process, fisher elim test) heatmaps"
...
BP.GO.data <- readRDS("topGO/BP/VTA_v2_all_comparsion_topGO_BP.RData")
elimfisher.result <- read.csv("topGO/BP/VTA_v2_all_comparsion_BP_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
