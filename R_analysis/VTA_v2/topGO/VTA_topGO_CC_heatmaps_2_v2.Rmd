---
title: "VTA all comparsion TopGO(cellular component, fisher elim test) heatmaps"
...
CC.GO.data <- readRDS("topGO/CC/VTA_v2_all_comparsion_topGO_CC.RData")
elimfisher.result <- read.csv("topGO/CC/VTA_v2_all_comparsion_CC_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
