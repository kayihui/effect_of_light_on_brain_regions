---
title: "VTA all comparsion TopGO(molecular functions, KS elim test) heatmaps"
...
elimKS.result <- read.csv("topGO/MF/VTA_v2_all_comparsion_MF_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
