...
result.wt.light.treatment <- readRDS("VTA_v2_WT_lightvsControl.RData")
result.Per1.light.treatment <- readRDS("VTA_v2_Per1_lightvsControl.RData")
result.WTvsPer1.control <- readRDS("VTA_v2_WTvsPer1_control.RData")
result.WTvsPer1.light.treatment <- readRDS("VTA_v2_WTvsPer1_light.RData")
result.different.in.light.response <- readRDS("VTA_v2_effectAcrossGenotype.RData")
...
write.csv(wt.light.treatment, "VTA_v2_WT_lightvsControl.csv", row.names = FALSE)
write.csv(Per1.light.treatment, "VTA_v2_Per1_lightvsControl.csv", row.names = FALSE)
write.csv(WTvsPer1.control, "VTA_v2_WTvsPer1_control.csv", row.names = FALSE)
write.csv(WTvsPer1.light.treatment, "VTA_v2_WTvsPer1_light.csv", row.names = FALSE)
write.csv(different.in.light.response, "VTA_v2_effectAcrossGenotype.csv", row.names = FALSE)
...
write.csv(Fulltable, "VTA_v2_all_comparsion.csv", row.names = FALSE)
