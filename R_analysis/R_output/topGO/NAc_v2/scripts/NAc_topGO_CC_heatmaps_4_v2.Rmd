---
title: "NAc WT w/o light TopGO(cellular component, KS elim test) heatmaps"
...
elimKS.result <- read.csv("CC/NAc_WT_light_CC_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(CC.GO.data, elimKS.result$GO.ID)
