---
title: "NAc WT w/o light TopGO(Biological process, fisher test) heatmaps"
...
fisher.result <- read.csv("BP/NAc_WT_light_BP_fisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(BP.GO.data, fisher.result$GO.ID)
