---
title: "NAc WT w/o light TopGO(cellular component, fisher test) heatmaps"
...
fisher.result <- read.csv("CC/NAc_WT_light_CC_fisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(CC.GO.data, fisher.result$GO.ID)
