---
title: "NAc WT w/o light TopGO(molecular functions, fisher elim test) heatmaps"
...
elimfisher.result <- read.csv("MF/NAc_WT_light_MF_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(MF.GO.data, elimfisher.result$GO.ID)
