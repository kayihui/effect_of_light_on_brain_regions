---
title: "NAc WT w/o light TopGO(Biological process, KS elim test) heatmaps"
...
elimKS.result <- read.csv("BP/NAc_WT_light_BP_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
