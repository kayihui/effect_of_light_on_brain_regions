---
title: "NAc TopGO(molecular functions) analysis - WT control vs light"
...
saveRDS(GO.data,"MF/NAc_WT_light_topGO_MF.RData")
write.csv(fisher.result, "MF/NAc_WT_light_MF_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "MF/NAc_WT_light_MF_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "MF/NAc_WT_light_MF_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "MF/NAc_WT_light_MF_elimKS.csv", row.names = FALSE)
```
