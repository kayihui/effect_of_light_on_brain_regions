---
title: "NAc WT w/o light TopGO(molecular functions, KS elim test) heatmaps"
...
elimKS.result <- read.csv("MF/NAc_WT_light_MF_elimKS.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(MF.GO.data, elimKS.result$GO.ID)
