...
saveRDS(GO.data,"BP/NAc_WT_light_topGO_BP.RData")
write.csv(fisher.result, "BP/NAc_WT_light_BP_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "BP/NAc_WT_light_BP_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "BP/NAc_WT_light_BP_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "BP/NAc_WT_light_BP_elimKS.csv", row.names = FALSE)
```
