---
title: "NAc WT w/o light TopGO(molecular functions, KS test) heatmaps"
...
KS.result <- read.csv("MF/NAc_WT_light_MF_KS.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(MF.GO.data, KS.result$GO.ID)
