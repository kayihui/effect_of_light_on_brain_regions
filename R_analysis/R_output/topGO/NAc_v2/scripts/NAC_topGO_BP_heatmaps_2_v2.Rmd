---
title: "NAc WT w/o light TopGO(Biological process, fisher elim test) heatmaps"
...
BP.GO.data <- readRDS("BP/NAc_WT_light_topGO_BP.RData")
elimfisher.result <- read.csv("BP/NAc_WT_light_BP_elimfisher.csv", header = TRUE, stringsAsFactors = FALSE)
```
...
gene.from.GOterms <- genesInTerm(BP.GO.data, elimfisher.result$GO.ID)
