---
title: "NAc TopGO(cellular component) analysis - WT control vs light"
...
saveRDS(GO.data,"CC/NAc_WT_light_topGO_CC.RData")
write.csv(fisher.result, "CC/NAc_WT_light_CC_fisher.csv", row.names = FALSE)
write.csv(elim.fisher.result, "CC/NAc_WT_light_CC_elimfisher.csv", row.names = FALSE)
write.csv(KS.result, "CC/NAc_WT_light_CC_KS.csv", row.names = FALSE)
write.csv(elim.KS.result, "CC/NAc_WT_light_CC_elimKS.csv", row.names = FALSE)
```
