...
# VTA
VTA_WT <- read.csv("~/Desktop/brainRNASeq/R_analysis/VTA_v2/VTA_v2_WT_lightvsControl.csv", header = TRUE, stringsAsFactors = FALSE)
VTA_Per1 <- read.csv("~/Desktop/brainRNASeq/R_analysis/VTA_v2/VTA_v2_Per1_lightvsControl.csv", header = TRUE, stringsAsFactors = FALSE)
