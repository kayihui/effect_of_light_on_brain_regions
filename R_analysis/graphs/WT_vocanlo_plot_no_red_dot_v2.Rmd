---
title: "WT light vs control volcano plots (VTA version 2 analysis)"
...
SCN <- read.csv("R_output/results_tables/SCN/SCN_WT_lightvsControl.csv", header = TRUE, stringsAsFactors = FALSE)
VTA <- read.csv("VTA_v2/VTA_v2_WT_lightvsControl.csv", header = TRUE, stringsAsFactors = FALSE)
LHb <- read.csv("R_output/results_tables/LHb/LHb_WT_lightvsControl.csv", header = TRUE, stringsAsFactors = FALSE)
NAc <- read.csv("R_output/results_tables/NAc/NAc_WT_lightvsControl.csv", header = TRUE, stringsAsFactors = FALSE)
